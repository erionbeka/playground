...
const themeSymbols: Record<string, string[]> = {
  ...
  sounds: ["Bell", "Drum", "Clap", "Horn"],
  animals: ["Dog", "Cat", "Rabbit", "Frog"],
  numbers: ["1", "2", "3", "4"],
  patterns: ["Star", "Moon", "Sun", "Rainbow"],
  "dance moves": ["Step", "Turn", "Clap", "Reach"],
  "musical notes": ["Do", "Re", "Mi", "Fa"],
  emotions: ["Happy", "Surprised", "Sad", "Excited"],
  actions: ["Run", "Jump", "Roll", "Walk"],
  vehicles: ["Car", "Bike", "Train", "Rocket"],
  foods: ["Apple", "Banana", "Berry", "Carrot"],
  seasons: ["Spring", "Summer", "Fall", "Winter"],
  "daily routine": ["Wake", "Brush", "Dress", "Eat"],
  "story order": ["Start", "Problem", "Magic", "Finish"],
  "morning routine": ["Wake", "Wash", "Dress", "Eat"],
  "getting dressed": ["Shirt", "Pants", "Socks", "Shoes"],
  "brushing teeth": ["Brush", "Paste", "Scrub", "Rinse"],
  "eating meals": ["Plate", "Food", "Bite", "Clean"],
  "washing hands": ["Water", "Soap", "Rub", "Dry"],
  "bedtime steps": ["PJs", "Brush", "Story", "Sleep"],
  "packing a bag": ["Bag", "Book", "Snack", "Zip"],
  "setting the table": ["Plate", "Cup", "Fork", "Napkin"],
  "tidying up": ["Pick", "Sort", "Put", "Done"],
  "going shopping": ["List", "Cart", "Pay", "Bag"],
